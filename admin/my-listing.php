...
<head>
    ...
    <!--Toggle Switch-->
    <link href="assets/css/plugins/toggleSwitch/css/toggle-switch.css" rel="stylesheet">
        ...
        $(document).ready(function(){
            $('.dataTables-products').dataTable({
                ...
                tableTools: {
                    ...
                    "sSwfPath": "<?=$adminbasepath;?>assets/js/plugins/dataTables/swf/copy_csv_xls_pdf.swf"
                }
            });
...
//                });
        ...
        $("#bulkActions a").click(function(){
            ...
            if(chkids.length>0){
                $.ajax({
                   type: 'POST',
                   url: "<?=$adminbasepath;?>includes/modules/ajax-update-product-status.php",
